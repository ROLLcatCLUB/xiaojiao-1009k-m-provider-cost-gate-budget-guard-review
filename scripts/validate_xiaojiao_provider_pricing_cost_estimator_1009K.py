...
SLUG="xiaojiao_provider_pricing_cost_estimator_1009K"
FINAL_STATUS="XIAOJIAO_PROVIDER_PRICING_CONFIG_AND_COST_ESTIMATOR_PASS"
MARKER="ALL_1009K_PROVIDER_PRICING_CONFIG_AND_COST_ESTIMATOR_CHECKS_OK"
REQUIRED=[
  "docs/foundation/xiaojiao_provider_pricing_cost_estimator_1009K.md",
  "docs/foundation/xiaojiao_provider_pricing_cost_estimator_1009K.json",
  "docs/audit/xiaojiao_provider_pricing_cost_estimator_1009K_result.json",
  "docs/audit/xiaojiao_provider_pricing_cost_estimator_1009K_report.md",
  "docs/audit_packages/xiaojiao_provider_pricing_cost_estimator_1009K_manifest.json",
  "docs/audit_packages/xiaojiao_provider_pricing_cost_estimator_1009K.zip",
  "scripts/validate_xiaojiao_provider_pricing_cost_estimator_1009K.py",
